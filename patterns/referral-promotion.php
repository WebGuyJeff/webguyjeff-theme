 ...
 * Slug: freedev/referral-promotion
 * Categories: freedev
...
$strings = array(
	'title'       => __( 'Refer Friends and Get Rewarded', 'freedev' ),
	'byline'      => __( 'We appreciate your loyalty and would like to offer you a little thanks for spreading the word. Refer a friend to get £25, then get an additional £25 for each friend after that!', 'freedev' ),
	'tiers'       => array(
		'item' => __( 'Referral', 'freedev' ),
		'nths' => array(
			'1' => __( '1st', 'freedev' ),
			'2' => __( '2nd', 'freedev' ),
			'3' => __( '3rd', 'freedev' ),
	...
	'tandc_title' => __( 'Terms and conditions', 'freedev' ),
);

$eyebrow_image = FREEDEV_URL . 'assets/svg/pattern-images/spread-the-love.svg';
$primary_image = FREEDEV_URL . 'assets/svg/pattern-images/shape-01.svg';
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignfull loyalty">
		...
		<!-- /wp:group -->
		<!-- wp:group {"align":"full","backgroundColor":"fdev-accent","layout":{"type":"constrained"}} -->
		<div class="wp-block-group alignfull has-fdev-accent-background-color has-background">
			...
			<div class="wp-block-group alignwide" style="padding-right:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
				<!-- wp:columns {"style":{"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg-alt"}}},"spacing":{"blockGap":{"left":"0"}}},"textColor":"fdev-fg-alt"} -->
				<div class="wp-block-columns has-fdev-fg-alt-color has-text-color has-link-color">
				...
				<div class="wp-block-columns has-overflow-hidden" style="border-radius:1rem;margin-bottom:var(--wp--preset--spacing--50);padding-right:0;padding-left:0">
					...
					<!-- /wp:column -->
					<!-- wp:column {"width":"50%","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|60","right":"var:preset|spacing|60"}}},"backgroundColor":"fdev-fg-alt"} -->
					<div class="wp-block-column has-fdev-fg-alt-background-color has-background" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--60);flex-basis:50%">
							...
							<div class="wp-block-group" style="padding-right:0;padding-left:0">
								...
								<div class="wp-block-group">
									...
									<div class="wp-block-cover has-square-aspect-ratio" style="border-radius:100rem;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20);min-height:3rem">
										<span aria-hidden="true" class="wp-block-cover__background has-fdev-bg-alt-background-color has-background-dim-100 has-background-dim"></span>
										<div class="wp-block-cover__inner-container">
											<!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg-alt"}}}},"textColor":"fdev-fg-alt","fontSize":"medium"} -->
											<p class="has-text-align-center has-fdev-fg-alt-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:700">£25</p>
											<!-- /wp:paragraph -->
										</div>
									</div>
									<!-- /wp:cover -->
								...
								<div class="wp-block-group">
									...
									<div class="wp-block-cover has-square-aspect-ratio" style="border-radius:100rem;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20);min-height:3rem">
										...
										<div class="wp-block-cover__inner-container">
											<!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg-alt"}}}},"textColor":"fdev-fg-alt","fontSize":"medium"} -->
											<p class="has-text-align-center has-fdev-fg-alt-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:700">£50</p>
											<!-- /wp:paragraph -->
										</div>
									</div>
									<!-- /wp:cover -->
								...
								<div class="wp-block-group">
									...
									<div class="wp-block-cover has-square-aspect-ratio" style="border-radius:100rem;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20);min-height:3rem">
										...
										<div class="wp-block-cover__inner-container">
											<!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg-alt"}}}},"textColor":"fdev-fg-alt","fontSize":"medium"} -->
											<p class="has-text-align-center has-fdev-fg-alt-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:700">£75</p>
											<!-- /wp:paragraph -->
										</div>
									</div>
									<!-- /wp:cover -->
								...
								<div class="wp-block-group">
									...
									<div class="wp-block-cover has-square-aspect-ratio" style="border-radius:100rem;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20);min-height:3rem">
										...
										<div class="wp-block-cover__inner-container">
											<!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg-alt"}}}},"textColor":"fdev-fg-alt","fontSize":"medium"} -->
											<p class="has-text-align-center has-fdev-fg-alt-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:700">£100</p>
											<!-- /wp:paragraph -->
										</div>
									</div>
									<!-- /wp:cover -->
								...
								<div class="wp-block-group">
									...
									<div class="wp-block-cover has-square-aspect-ratio" style="border-radius:100rem;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20);min-height:3rem">
										...
										<div class="wp-block-cover__inner-container">
											<!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg-alt"}}}},"textColor":"fdev-fg-alt","fontSize":"medium"} -->
											<p class="has-text-align-center has-fdev-fg-alt-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:700">£125</p>
											<!-- /wp:paragraph -->
										</div>
									</div>
									<!-- /wp:cover -->
								...
								<div class="wp-block-group">
									...
									<div class="wp-block-cover has-square-aspect-ratio" style="border-radius:100rem;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20);min-height:3rem">
										...
										<div class="wp-block-cover__inner-container">
											<!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg-alt"}}}},"textColor":"fdev-fg-alt","fontSize":"medium"} -->
											<p class="has-text-align-center has-fdev-fg-alt-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:700">£150</p>
											<!-- /wp:paragraph -->
										</div>
									</div>
									<!-- /wp:cover -->
						...
						<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
							<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"800","textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|fdev-fg"}}}},"textColor":"fdev-fg","fontFamily":"body"} -->
							<h3 class="wp-block-heading has-text-align-center has-fdev-fg-color has-text-color has-link-color has-body-font-family" style="font-style:normal;font-weight:800;text-transform:uppercase">Share Now!</h3>
							<!-- /wp:heading -->
							<!-- wp:social-links {"iconColor":"fdev-yellow","iconColorValue":"#ffb129","iconBackgroundColor":"fdev-fg","iconBackgroundColorValue":"#181818","openInNewTab":true,"size":"has-large-icon-size","className":"is-style-default","layout":{"type":"flex","justifyContent":"center"}} -->
				...
				<div class="wp-block-group">
					<!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|fdev-bg"}}},"spacing":{"padding":{"bottom":"var:preset|spacing|50"}}},"textColor":"fdev-bg","layout":{"type":"constrained"},"fontSize":"small"} -->
					<div class="wp-block-group has-fdev-bg-color has-text-color has-link-color has-small-font-size" style="padding-bottom:var(--wp--preset--spacing--50)">
						<!-- wp:paragraph {"align":"center"} -->
		...
		<!-- /wp:group -->
		<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"blockGap":"0"}},"backgroundColor":"fdev-accent","layout":{"type":"constrained"}} -->
		<div class="wp-block-group alignfull has-fdev-accent-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
